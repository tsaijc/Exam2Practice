...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        for k in range(leftover, len(additional_contents)):
            strng = strng + additional_contents[k]
        return strng
    ...
    def double(self):
        ...
        remaining = self.append_string(self.contents)
        return remaining
    ...
    def double_then_shrink(self, new_volume):
        ...
        count = 0
        count = count + len(self.double())
        count = count + len(self.shrink(new_volume))
        return count
    ...
    def steal(self, other_box):
        ...
        strng = self.append_string(other_box.contents)
        other_box.contents = strng
